...
class GetEarliestCheckInCustomer @Inject constructor(private val repository: CustomerRepository) {
    ...
    suspend operator fun invoke(): CustomerModel {
        ...
        return nonNullCustomers.minBy { LocalDate.parse(it.lastCheckInDate, formatter) }
    }
}